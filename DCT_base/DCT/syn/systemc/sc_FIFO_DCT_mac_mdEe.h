...
#ifndef __sc_FIFO_DCT_mac_mdEe__HH__
#define __sc_FIFO_DCT_mac_mdEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sc_FIFO_DCT_mac_mdEe) {
    ...
    SC_CTOR(sc_FIFO_DCT_mac_mdEe):  simcore_mac_1_U ("simcore_mac_1_U") {
