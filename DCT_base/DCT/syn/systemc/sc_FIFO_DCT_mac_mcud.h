...
#ifndef __sc_FIFO_DCT_mac_mcud__HH__
#define __sc_FIFO_DCT_mac_mcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(sc_FIFO_DCT_mac_mcud) {
    ...
    SC_CTOR(sc_FIFO_DCT_mac_mcud):  simcore_mac_0_U ("simcore_mac_0_U") {
