...
#ifndef __sc_FIFO_DCT_sc_FIfYi_H__
#define __sc_FIFO_DCT_sc_FIfYi_H__
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(sc_FIFO_DCT_sc_FIfYi_ram) {
...
sc_FIFO_DCT_sc_FIfYi_ram* meminst;


SC_CTOR(sc_FIFO_DCT_sc_FIfYi) {
