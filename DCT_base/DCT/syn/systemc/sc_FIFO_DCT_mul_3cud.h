...
#ifndef __sc_FIFO_DCT_mul_3cud__HH__
#define __sc_FIFO_DCT_mul_3cud__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sc_FIFO_DCT_mul_3cud) {
    ...
    SC_CTOR(sc_FIFO_DCT_mul_3cud):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
