...
#ifndef __sc_FIFO_DCT_mul_8bkb__HH__
#define __sc_FIFO_DCT_mul_8bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(sc_FIFO_DCT_mul_8bkb) {
    ...
    SC_CTOR(sc_FIFO_DCT_mul_8bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
