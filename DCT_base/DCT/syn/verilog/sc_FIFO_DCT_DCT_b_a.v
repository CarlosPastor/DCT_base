...
`timescale 1 ns / 1 ps
(* rom_style = "distributed" *) module sc_FIFO_DCT_DCT_b_a_rom (
...
initial begin
    $readmemh("./sc_FIFO_DCT_DCT_b_a_rom.dat", ram0);
    $readmemh("./sc_FIFO_DCT_DCT_b_a_rom.dat", ram1);
    $readmemh("./sc_FIFO_DCT_DCT_b_a_rom.dat", ram2);
    $readmemh("./sc_FIFO_DCT_DCT_b_a_rom.dat", ram3);
end
...
sc_FIFO_DCT_DCT_b_a_rom sc_FIFO_DCT_DCT_b_a_rom_U(
    .clk( clk ),
    .addr0( address0 ),
    .ce0( ce0 ),
    .q0( q0 ),
