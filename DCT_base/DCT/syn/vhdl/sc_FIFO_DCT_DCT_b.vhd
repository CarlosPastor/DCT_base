...
entity sc_FIFO_DCT_DCT_b_rom is 
    generic(
             dwidth     : integer := 8; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of sc_FIFO_DCT_DCT_b_rom is 
...
architecture arch of sc_FIFO_DCT_DCT_b is
    component sc_FIFO_DCT_DCT_b_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    sc_FIFO_DCT_DCT_b_rom_U :  component sc_FIFO_DCT_DCT_b_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
