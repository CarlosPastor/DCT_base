...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    op interface \
    ports { sc_FIFO_DCT_mA_address0 { O 6 vector } sc_FIFO_DCT_mA_ce0 { O 1 bit } sc_FIFO_DCT_mA_we0 { O 1 bit } sc_FIFO_DCT_mA_d0 { O 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { s_buffered { O 1 bit } s_buffered_ap_vld { O 1 bit } } \
} "
}
