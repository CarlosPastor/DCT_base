<project xmlns="com.autoesl.autopilot.project" name="DCT_base" top="sc_FIFO_DCT" projectType="SystemC">
    ...
    <files xmlns="">
        ...
        <file name="../../sc_FIFO_IDCT.h" sc="1" tb="1" cflags=" "/>
        <file name="../../sc_FIFO_IDCT.cpp" sc="1" tb="1" cflags=" "/>
        <file name="../../qdbmp.h" sc="1" tb="1" cflags=" "/>
        <file name="../../qdbmp.cpp" sc="1" tb="1" cflags=" "/>
        <file name="../../lena512.bmp" sc="1" tb="1" cflags=" "/>
        <file name="../../imager_512.h" sc="1" tb="1" cflags=" "/>
        <file name="../../imager_512.cpp" sc="1" tb="1" cflags=" "/>
        <file name="../../blocker_512.h" sc="1" tb="1" cflags=" "/>
        <file name="../../blocker_512.cpp" sc="1" tb="1" cflags=" "/>
