...
static const double b_a[64] = { 0.3536, 0.4904, 0.4619, 0.4157, 0.3536, 0.2778,
		...
		static const double b[64] = { 0.3536, 0.3536, 0.3536, 0.3536, 0.3536, 0.3536,
   ...
   while(true)
   {
      ...
      for (i0 = 0; i0 < 8; i0++) {
        for (i1 = 0; i1 < 8; i1++) {
          a[i0 + (i1 << 3)] = 0.0;
          for (i2 = 0; i2 < 8; i2++) {
            a[i0 + (i1 << 3)] += b_a[i0 + (i2 << 3)] * A[i2 + (i1 << 3)];
          }
        }
        ...
        for (i1 = 0; i1 < 8; i1++) {
          B[i0 + (i1 << 3)] = 0.0;
          for (i2 = 0; i2 < 8; i2++) {
            B[i0 + (i1 << 3)] += a[i0 + (i2 << 3)] * b[i2 + (i1 << 3)];
          }
          dout.write(B[i0 + (i1 << 3)]);
        }
      }
      done = true;
      wait();
